    ...
    <div id="header">
        <div class="freego_header clearfix" id="head_nav_warper">
            ...
            <ul class="head_nav" id="_j_head_nav" role="tablist">
                ...
                <li id="head_nav_scenic_li" role="presentation"><a href="/ScenicServlet?userId=1014&methodName=queryScenicIndex&currentPage=1&rows=10" id="head_nav_scenic_a" title="景点">景点</a></li>
